    ...
    <div>
      <main className="mx-auto max-w-4xl px-4 py-6 sm:px-6 sm:py-12">
        ...
        <section className="mt-6 rounded border bg-white p-6 shadow-sm">
          <h2 className="text-lg font-medium text-zinc-900">Your Info</h2>
          <div className="mt-4 text-sm text-zinc-600">Name: Inushi Kavindi</div>
          <div className="mt-1 text-sm text-zinc-600">Email: inushi@example.com</div>
        </section>
      </main>
    </div>
  );
