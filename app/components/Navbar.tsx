      ...
      <header className="sticky top-0 left-0 right-0 z-50 w-full border-b bg-white/95 backdrop-blur dark:border-zinc-800 dark:bg-[#0b0b0b]/95">
        <div className="mx-auto flex w-full items-center justify-between px-4 py-4 sm:px-6">
          ...
          <div className="flex items-center gap-2">
            <Link href="/profile" className="flex items-center gap-3 rounded px-3 py-2 hover:bg-zinc-100 dark:hover:bg-zinc-900">
              <span className="inline-grid h-8 w-8 place-items-center rounded-full bg-zinc-200 text-zinc-700 dark:bg-zinc-700 dark:text-zinc-100">
