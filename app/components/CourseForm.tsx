    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      <div>
        ...
        <input
          ...
          className={`mt-1 w-full rounded border bg-white px-3 py-2 text-zinc-900 shadow-sm focus:outline-none focus:ring-2 dark:bg-zinc-900 dark:text-zinc-50 dark:placeholder-zinc-400 ${
            errors.title ? "border-red-500 focus:ring-red-300 dark:border-red-500" : "border-zinc-300 focus:ring-zinc-400 dark:border-zinc-700"
          }`}
      ...
      <div>
        ...
        <textarea
          ...
          className={`mt-1 w-full rounded border bg-white px-3 py-2 text-zinc-900 shadow-sm focus:outline-none focus:ring-2 dark:bg-zinc-900 dark:text-zinc-50 dark:placeholder-zinc-400 ${
            errors.desc ? "border-red-500 focus:ring-red-300 dark:border-red-500" : "border-zinc-300 focus:ring-zinc-400 dark:border-zinc-700"
          }`}
          rows={4}
      ...
      <div>
        ...
        <input
          ...
          className={`mt-1 w-full rounded border bg-white px-3 py-2 text-zinc-900 shadow-sm focus:outline-none focus:ring-2 dark:bg-zinc-900 dark:text-zinc-50 dark:placeholder-zinc-400 ${
            errors.code ? "border-red-500 focus:ring-red-300 dark:border-red-500" : "border-zinc-300 focus:ring-zinc-400 dark:border-zinc-700"
          }`}
